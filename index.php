...
<div id="pageMiddle">
 ...
 <!--<a href = "logout.php">Sign Out</a>--></div>
        <div id="pmcenter">
        	<br>
        	<div style="font-size:50px;font-family:'Palatino Linotype', 'Book Antiqua', Palatino, serif"><h1 style="text-transform:capitalize;font-size:80px;">BOOK ORGANISER</h1><h1 style="text-transform:capitalize;font-size:60px;">WELCOME</h1></div>
